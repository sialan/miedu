...
class Lesson(models.Model):
    ...
    partner_dp = FileBrowseField("Image", max_length=200, extensions=[".jpg", ".png", ".gif"], blank=True, null=True)
    credit_name = models.CharField(max_length=10, null=True, blank=True)
    credit_value = models.IntegerField(null=True, blank=True)
    image = FileBrowseField("Image", max_length=200, extensions=[".jpg", ".png", ".gif"], blank=True, null=True)
